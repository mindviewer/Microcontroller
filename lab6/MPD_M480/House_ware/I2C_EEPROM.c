...
#define I2C_EEPROM_IRQn I2C2_IRQn
...
__INLINE void I2C_PIN_Init(void)
{
    ...
    SYS->GPD_MFPL |= SYS_GPD_MFPL_PD1MFP_I2C2_SCL;

    SYS->GPD_MFPL &= ~SYS_GPD_MFPL_PD0MFP_Msk;
    SYS->GPD_MFPL |= SYS_GPD_MFPL_PD0MFP_I2C2_SDA;
...
void I2C_EEPROM_Init(void)
{
    ...
    I2C_Open(I2C_EEPROM, 100000);	// 100kbps standard, 400kbps fast, 1Mbps fast plus
...
void I2C_MasterRx(uint32_t u32Status)
{
    if(u32Status == 0x08)                       /* START has been transmitted and prepare SLA+W */
    {
        ...
        I2C_SET_CONTROL_REG(I2C_EEPROM, I2C_CTL_SI);				/*SI -> interrupt flag*/
    }
...
void I2C_MasterTx(uint32_t u32Status)
{
    ...
    {
        I2C_SET_DATA(I2C_EEPROM, g_u8DeviceAddr << 1);    /* Write SLA+W(Slave address + Write bit) to Register I2CDAT */
        I2C_SET_CONTROL_REG(I2C_EEPROM, I2C_CTL_SI);
    }
    else if(u32Status == 0x18)                  /* SLA+W has been transmitted and ACK has been received */
    {
